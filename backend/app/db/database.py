...
def ensure_public_tables(db):
    ...
    public_queries = [
        ...
        "CREATE TABLE IF NOT EXISTS public.protheus_modules_master (mod_code VARCHAR(30) PRIMARY KEY, mod_name VARCHAR(150) NOT NULL, description TEXT);",
